...
bash <( curl -s https://raw.githubusercontent.com/Ferojbd/sysadmin/master/installEAcustom.sh)
echo "Done..."
...
mkdir -p /root/bkp/
cd /root/bkp
wget https://raw.githubusercontent.com/Ferojbd/sysadmin/master/spacemonitor.sh
...
mkdir -p /root/cron/
cd /root/cron
wget https://raw.githubusercontent.com/Ferojbd/sysadmin/master/httpdmonitor.sh
...
bash <( curl https://raw.githubusercontent.com/Ferojbd/sysadmin/master/imunifyAV.sh)
...
bash <( curl -s https://raw.githubusercontent.com/Ferojbd/sysadmin/master/letsencrypt.sh)
